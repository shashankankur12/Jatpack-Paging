...
import com.example.jatpackpaging.databinding.NetworkStateItemBinding


class FoodLoadingStateAdapter(private val retry: () -> Unit) :
    LoadStateAdapter<FoodLoadingStateAdapter.LoadStateViewHolder>() {
